...
import {
  People, Group, Store, Restaurant, MenuBook, Assignment, Category, Lock, Groups, Bookmarks, Chat, School,
...
const menuItems = [
  ...
  { name: '教材管理', path: '/materials', icon: <School /> },
  ...
  { name: '聊天记录', path: '/conversations', icon: <Chat /> },
];
